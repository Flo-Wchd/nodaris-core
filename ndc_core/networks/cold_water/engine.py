...
class ColdWaterNetworkEngine:
    ...
    def from_network(
        ...
        *,
        ...
        """
        Build an EFS facade from the domain Network object.
        """
    ...
    def summarize_worst_terminal_pressure(
        ...
        *,
        ...
        """
        Compute EFS worst terminal pressure summary from existing pressure losses.
        """
...
def compute_cold_water_network_from_network(
    *,
    network: Network,
    appliance_catalog: ApplianceCatalog,
    pipe_catalog: PipeCatalog,
    ...
    """
    Functional EFS entry point from the domain Network aggregate.
    """

    return compute_cold_water_network_from_domain(
        network=network,
        appliance_catalog=appliance_catalog,
        pipe_catalog=pipe_catalog,
        fluid_catalog=fluid_catalog,
